    ...
    try:
        ...
        if is_broad:
            system_content = (
                ...
                "Строго следуй порядку изложения в контексте — не переставляй шаги местами.\n"
                "Строго запрещено придумывать шаги, роли, ограничения, числа, лимиты, сроки и требования, которых нет в контексте.\n"
                "Вопрос общий: можно и нужно объединять шаги из разных документов в один связный нумерованный список со сквозной нумерацией (1. 2. 3. ...).\n"
                "Блок 'Наиболее релевантные фрагменты' — это подсказка; если там есть прямой ответ, используй его и не отвечай 'Информация в документах не найдена'.\n"
                "Если в контексте нет ничего по сути вопроса, ответь ровно одной фразой: Информация в документах не найдена.\n"
                ...
                "Включай все значимые шаги из контекста, в том числе подсказки, исправления ошибок и важные замечания.\n"
                ...
                "Не используй формулы LaTeX, $-обёртки и команды вроде \\rightarrow: для стрелок пиши обычный символ → или слово 'затем'.\n"
