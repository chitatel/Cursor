            ...
            [
                {
                    ...
                    "content": (
                        ...
                        "Если ответ есть — перескажи его кратко, сохраняя последовательность из контекста.\n"
                        "Формат выбирай по смыслу вопроса: если спрашивают 'какие бывают', 'виды', 'типы', 'перечислить' — дай список элементов; если спрашивают 'как сделать', 'порядок', 'процесс' — дай пошаговую инструкцию.\n"
